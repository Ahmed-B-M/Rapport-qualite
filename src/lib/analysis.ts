...
const MOTS_CLES_CATEGORIES: { categorie: CategorieProbleme, motsCles: string[] }[] = [
    { categorie: "attitude livreur", motsCles: ["pas aimable", "agressif", "impoli", "désagréable", "pas bonjour", "comportement", "odieux", "odieuse", "incorrecte", "mal poli", "catastrophe", "horrible", "pas serviable", "agressive", "pressé", "impatient", "sur le trottoir", "expéditif", "fait le signe pour avoir la pièce", "pas professionnel", "pas très aimable", "débrouillez vous", "davantage d'aide", "mauvaise foi", "laisser les sacs", "devant la maison", "mauvaise adresse", "porter les sacs", "irrespectueux", "arrogant", "énervés", "agacé", "livrées à l'extérieur", "brutal", "insultant", "pas descendu", "livré à 400m", "trompent de rue", "jetant les sacs"] },
    ...
    { categorie: "produits manquants", motsCles: ["manquant", "manque", "oubli", "pas tout", "pas reçu", "incomplet", "pas eu", "produit manquant", "sac qui ne nous a pas été livré", "manquait", "pris", "mauvaise commande", "problèmes avec des produits dans le sac", "pas voulu reprendre", "non livrés"] },
